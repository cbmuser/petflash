;---------------------------------------------------------
;
;  PET ROM/RAM Flasher Software
;
;  Basic 2 Beta , 11. April 2005
;
;--------------------------------------------------------- 
;
;
...
*=$0e00
!PET "     flash programmer for cbm pet       "
!PET "                                        "
!PET "                                        "
!PET "                                        "
!PET " options:                               "
...
ex_buf !PET "have a nice day hacker !                "
                 
                 
; end of source : $1468 , free space up to $2f00
